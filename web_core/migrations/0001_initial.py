    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cach_dung', models.ForeignKey(limit_choices_to={'loai': 'Cách dùng'}, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='cach_dung', to='web_core.danhmuc')),
                ('don_vi', models.ForeignKey(limit_choices_to={'loai': 'Đơn vị'}, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='don_vi', to='web_core.danhmuc')),
                ...
                ('thuoc', models.ForeignKey(limit_choices_to={'loai': 'Thuốc'}, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='thuoc', to='web_core.danhmuc')),
            ],
        ),
    ]
